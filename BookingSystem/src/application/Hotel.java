...
public class Hotel
{
    ...
    {
        double amount = 0;
        String list[] = {"Beef Steak","Pasta","Noodles","Coke"};
        System.out.println("\n*******");
        ...
        switch(rtype)
        {
            case 1: amount += 4000;
                    ...
                    System.out.println("-------------------------");
                    for(Food obb:hotel_ob.luxury_doubleroom[rn].food) // for each
                    {
                        amount+=obb.price;
            ...
            case 2: amount += 3000;
                    ...
                    System.out.println("===============");
                     System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food obb:hotel_ob.deluxe_doubleroom[rn].food) // for each
                    {
                        amount += obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.itemNo-1],obb.quantity,obb.price + " $");
            ...
            case 4: amount += 1200;
                    ...
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food obb:hotel_ob.deluxe_singleroom[rn].food) // for each
                    {
                        amount+=obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf( format,list[obb.itemNo-1],obb.quantity,obb.price + " $");
    ...
    public static void order(int rn,int rtype)
    {
        ...
        char wish;
         try{
             System.out.println("\n==========\n   Menu from Attila Chef's kitchen:  \n==========\n\n1.Beef Steak\t90 $\n2.Pasta\t\t60 $\n3.Noodles\t70 $\n4.Coke\t\t20 $\n");
        do
        {
            i = sc.nextInt();
